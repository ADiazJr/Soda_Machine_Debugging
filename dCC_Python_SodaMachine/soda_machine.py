import cans
import coins
from user_interface import display_welcome, end_message, output_text, soda_selection
...
class SodaMachine:
    ...
    def run_transaction(self, customer):
        self.fill_inventory()
        self.fill_register()
        selected_soda_name = soda_selection(self.inventory)
        ...
        output_text("Transaction complete")
    ...
    def calculate_transaction(self, customer_payment, selected_soda, customer):
        ...
        if total_payment_value > selected_soda.price:
            ...
            if customer_change is None:
                ...
                end_message(selected_soda, change_value)
